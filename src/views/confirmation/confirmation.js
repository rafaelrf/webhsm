                                    ...
                                    <Card className="p-4">
                                        <CardBody>
                                            <Form onSubmit={(e) =>  this.props.confirmarAgendamento(e,this.props.dados)}>
                                                ...
                                                <InputGroup className="mb-4">
                                                    <h5>Data da Consulta: {
                                                        moment(this.props.dados.agendaescolhida.dtreferencia, "DD/MM/YYYY").format("DD/MM/YYYY") +" "+
                                                        moment(this.props.dados.agendaescolhida.hrinicon, "DD/MM/YYYY HH:mm").format("HH:mm")
                                                    }</h5>
                                                </InputGroup>
                                                <Row>
                                                    <Col xs="12">
                                                        <Button color="primary" block className="px-4" ><h4>Confirmar Agendamento</h4></Button>
                                                    </Col>
                                                </Row>
                                            </Form>
                                        </CardBody>
